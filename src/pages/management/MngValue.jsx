  ...
  return (
    <div>
      <div className='mngInner'>
        ...
        <div className='mngMenuTab'>
          <span>기업가치평가</span>
          <span>기술가치평가</span>
        </div>
        <div className='mngValueBusiness'>
          <h2 className='mngSmTitle'>기업가치평가</h2>
        ...
        <div className='mngSkillValue'>
          <h2 className='mngSmTitle'>기술가치평가</h2>
          <h4 className='mngValueTxt'>필요성</h4>
          <div className='mngNeedTxt'>
            <p>
          ...
          <div class="mngCircleWrap">
            <div class="mngCircleBg"></div>
            <div class="mngCircle">
              <div class="mngCircleItem mngCircleItemObject"><span class="mngCircleText">기술적 위치 분석</span></div>
              <div class="mngCircleItem mngCircleItemConnection"><span class="mngCircleText">산업분석</span></div>
              <div class="mngCircleItem mngCircleItemSpace"><span class="mngCircleText">기술가치 종합분석</span></div>
            </div>
          </div>
