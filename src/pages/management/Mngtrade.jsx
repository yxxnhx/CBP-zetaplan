...
const MngTrade = ({setHdSubStyle}) => {
  const title = '국내는 물론, 해외로 나아갈 기술이전 컨설팅을 지원합니다.'
    ...
    <div>
      ...
      <PageBase>
        <div className='mngInner'>
          ...
          <div className='darkText mngSummary mngTradeTxt'>
        ...
        <div className='mngInner'>
          <h2 className='darkText mngSubTitleNb mngTradePro'>Process</h2>
          <div className='mngTradeEdge'>
            <div className='mngTradeProcessImg'>img</div>
          </div>
        </div>
      </PageBase>
    </div>
