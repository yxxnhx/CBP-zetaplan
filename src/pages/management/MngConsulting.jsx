    ...
    <div>
      ...
      <div className='mngInner'>
        ...
        <div className='mngCircleTxt'>
          <p>경영정보에는 Application, Data Base, EIS/DSS, OA가 있고, 경영자원에는 사람, 자금, 자재, 설비, 정보인프라, 문화가 있으며 경영 process에는 업무절차, 통제지침, 보고절차,<br />Report(산출물)이 있고 경영전략에는 Vision, Mission, Objective (목표), CSF (주요성공요소), Issue (현안긴급과제), C.A (주요가정)이 있습니다.
          </p>
        </div>
        <div>
