        ...
        <div className="darkBackground">
          <div className="gbInner">
            ...
            <div className="gbContentTitle darkText">
              (주)제타플랜인베스트는 중국,대만,베트남, 싱가폴,일본 등<br /> 전 세계적으로 우수한 해외 네트워크를
              보유하고 있습니다.
            </div>
            ...
            <p className="gbMaterialContent darkText">
              • 해외기술이전사업 진출이후 베이징기술교역촉진중심, Transpacific IP, IPA VIETNAM,
              주한영국상공회의소(BCCK), 이스라엘 ABG 등과 기술이전 업무협약을 체결하였고, 그 외 해외 정부기관들을 통한
              기술이전 네트워크 구축
            </p>
            <p className="gbMaterialContent darkText">
            ...
            <p className="gbMaterialContent darkText">
              • 기업의 업종 및 성장단계에 맞는 투자자 정보 제공, 투자유치 설명회 개최 및 관심 투자자 매칭 지원 등
              투자유치 정보제공
            </p>
            ...
            <p className="gbMaterialContent darkText">
              - “기술기반” 국내업체의 성공적인 해외시장 진출을 위해, 해외 현지 경험과 컨설팅 능력을 갖춘 글로벌기술
              사업화 센터(GCC)를 통해 종합적인 글로벌 기술 사업화 컨설팅 서비스를 제공합니다.
            </p>
            <p className="gbMaterialContent darkText">
            ...
            <p className="gbMaterialContent darkText">
              ...
              시장조사, 고객평가, 잠재수요처 발굴, 잠재수요처 컨택 및 거래, 알선, 법률, 계약, 회계, 세무 등의 종합
              컨설팅 원스탑 서비스 제공
            </p>
            <p className="gbMaterialContent darkText">
