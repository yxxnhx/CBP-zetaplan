        ...
        <div className="gbAccoContentBox">
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  Beijing B&R International Co-incubation(ICI)는 인큐베이션 서비스 제공 업체를 서로 연결하고
                  <br /> 파트너십을 촉진하는 임무를 가진 비영리 및 비정부 네트워크임
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  중국 베이징 기술 교류 촉진 센터는 산업의 발전에 따른 중국기술의 향상을 위해 중국기업의
                  <br /> 해외 특허기술 이전을 지원하는 기관임.
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  상하이기술거래소(STTE)는 중국 최초의 국가급 종산 Technomart 로서
                  <br /> 중국 과학기술부와 상하이시 인민정부에 의해 1993년 12월 설립
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  중국 절강성 기술교류 네트워크와 연계된 절강성 과학기술국 산하 직속 기관으로
                  <br /> 중국 과학기술부와 절강성 항주시 인민정부에 의해 2008년 12월 설립
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  천진시 북방기술교역시장은 중국 하북성 기술교류 네트워크와 연계된
                  <br /> 천진시 과학기술국 산하 직속 기관으로 중국 과학기술부와 천진시 인민정부에 의해 1995년 3월 설립
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  온주시 과기합작교류중심은 중국 절강성 기술교류 네트워크와 연계된
                  <br /> 온주시 과학기술국 산하 직속 기관으로 중국 과학기술부와 절강성 온<br /> 주시 인민정부에 의해
                  2009년 8월 설립
                </li>
              </ul>
            </div>
          ...
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                <li>
                  대외 무역 진흥 및 외국의 선진 기술 도입과 투자 유치, 외국과 각종 형태의 경제,
                  <br /> 기술협력 활동을 하고 있으며 중국에서 가장 핵심적이며 커다란 국제무역 진흥 기관임.
                </li>
                <li>
                  중국 전역에 걸쳐 지소가 마련되어 있으며 특히 청두와 창사 지소는 EEN 중국파트너로
                  <br /> 2011년 이후 국내기업의 중국 진출을 위해 다양한 협력을 시도 중
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  국가 각 부서간의 협조를 통하여 정부의 기능과 시장의 규칙을 조율하고
                  <br /> 공동으로 힘을 모아 중국의 과학기술 성과를 산업화
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  중국 산동성 교주시는 중국 청도시 남동쪽의 교주만에 위치하고 있으며,
                  <br /> 1987년 2월, 청도시의 첫 번째 위성 도시로 국무원의 승인을 받은 도시
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="gbAccoContentBox">
          ...
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  국가의 지적 재산권 시스템의 개발과 관련된 프로그램과 프로젝트 수립,
                  <br /> 법률에 따라 산업 재산권의 설립을 위한 절차 등을 수행하고 있음
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  북베트남 29개 북부 지방에서 투자 활동을 지원하는 기능을 수행하는 외국인 투자 기관,
                  <br /> 기획 투자를 지원하는 기관으로 FIA(Ministry of Planning and Investment
                  <br /> (베트남 기획재정부) 산하 외국인투자청(Foreign Investment Agency))의 산하기관
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                <li>
                  IPOS는 지적 재산권 (IP) 정권을 관리 및 조언과
                  <br /> 싱가포르의 IP 에코 시스템의 개발을 촉진하기 위해 전문 지식을 구축하였음
                </li>
                <li>
                  IP가 오늘날의 글로벌 시장에서 중요한 자산이 되면서,
                  <br /> IPOS는 지식 경제의 모든 제작자 권한을 부여하며 신뢰할 수 있는 파트너가 될 것을 목표로 하고 있음
                </li>
              </ul>
            </div>
          </div>
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                <li>
                  국내 및 글로벌 수준의 지적 재산권의 발전에 대응하기 위해, 본부는 말레이시아 법<br /> 2002 년 지적
                  재산권 공사의 시행과 함께, 말레이시아의 지적 재산권 공사 (PHIM)로
                  <br /> 2003년 3월 3일에 법인화
                </li>
          ...
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  5개의 대상 영역(농업 및 식품 , 에너지 및 환경 , 보건 및 의료 , 생물 자원 및<br /> 지역 사회 와 제조 및
                  서비스 산업)에 초점을 맞추어 기능 재료, 센서 및 지능형 시스템,
                  <br /> 디지털 공학, 서비스 연구로 구분하여 연구개발함
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="gbAccoContentBox">
          ...
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                <li>
                  한국 상공 영국 상공 회의소 (BCCK)는 모든 국적의 개인과 기업에 열려
                  <br /> 한국의 주요 국제 및 지역 비즈니스 포럼
                </li>
          ...
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                ...
                <li>
                  EU(유럽연합)를 중심으로 유럽, 미국 등 54개국 600여개 기관이
                  <br /> 참여하고 있는 세계 최대 규모의 기술ㆍ비즈니스협력 네트워크임
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="gbAccoContentArea">
            ...
            <div className="gbAccoContentC">
              <ul>
                <li>
                  기술과 비즈니스 스카우트 서비스, 시장 전략, 사업 개발 및 판매 서비스를
                  <br /> 제공하며 이를 위해 일본 ABG는 중국, 한국, 회사와 제휴하고 있음
                </li>
                <li>
                  ABG와 파트너들은 이스라엘의 기술을 찾고 아시아 시장에서의 성공에 대한
                  <br /> 전문적인 서비스를 이스라엘 회사뿐만 아니라 아시아 기업에도 제공
                </li>
              </ul>
            </div>
          </div>
