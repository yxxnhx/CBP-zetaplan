...
const IrProcess = () => {
  return (
    <div>
      ...
      <div id="irProContent">
        <ul class='irProContentList'>
          <li class='content'>
            <h2>전략수립</h2>
            <div class="irContentBody">
              ...
              <p>예비진단 단계에서 핵심역량을 판단할 수 있도록 지원하며 그 핵심역량으로 성공적인 사업추진을 할 수 있도록 사업 전략 및 계획수립을 지원합니다</p>
              ...
              <p>재무분석에서 추정재무제표작성 및 기업가치 평가를 진행하며 기준 및 역량분석에서는 사전절차 확인 및 주요사항을 준비합니다. 실행전략에서 추진전략 및 세부 실행 계획 수립을 하여 성공적인 진단을 진행합니다.</p>
            </div>
          </li>
          <li class='content'>
            <h2>역량강화</h2>
