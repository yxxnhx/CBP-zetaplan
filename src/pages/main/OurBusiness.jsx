        ...
        <div className="obInner">
          <div className="obList professional">
            <div className="videoCon">
              <video src={professional} autoPlay loop muted playsInline></video>
          ...
          <div className="obList global">
            <div className="videoCon">
              <video src={global} autoPlay loop muted playsInline></video>
              <div className="obVideoDes">
          ...
          <div className="obList trust">
            <div className="videoCon">
              <video src={trust} autoPlay loop muted playsInline></video>
              <div className="obVideoDes">
          ...
          <div className="obList customized">
            <div className="videoCon">
              <video src={customized} autoPlay loop muted playsInline></video>
              <div className="obVideoDes">
