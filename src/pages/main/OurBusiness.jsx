        ...
        <div className="obInner">
          <div className="obList professional">
            <div className="videoCon">
              <video src={professional} loop muted autoPlay playsinline></video>
          ...
          <div className="obList global">
            <div className="videoCon">
              <video src={global} loop muted autoPlay playsinline></video>
              <div className="obVideoDes">
          ...
          <div className="obList trust">
            <div className="videoCon">
              <video src={trust} loop muted autoPlay playsinline></video>
              <div className="obVideoDes">
          ...
          <div className="obList customized">
            <div className="videoCon">
              <video src={customized} loop muted autoPlay playsinline></video>
              <div className="obVideoDes">
