...
const ConsulModal = ({open, close}) => {
  ...
  return (
    <div>
      <div className={open ? 'consulOpenModal consulModal' : 'consulModal'}>
        {
          open ? (
            <div className="consulModalArea">
              ...
              <div className="consulBox">
                <div className="consulBg">
                  ...
                  <h2 className='zetaLogo'>zetapaln</h2>
                </div>
                <div className="consulForm">
                  <div className="consulFormTop">
